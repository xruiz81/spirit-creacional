...
public abstract class JPCompra extends SpiritModelImpl {
	public JPCompra() {
		initComponents();
	}
		...
		//======== jtpCompras ========
		{
			...
			//======== spCabecera ========
			{
				...
				//======== panel32 ========
				{
					...
					panel32.add(btnBuscarProveedor, cc.xywh(13, 9, 1, 1, CellConstraints.FILL, CellConstraints.FILL));
					...
					panel32.add(btnActivarBusquedaOrdenes, cc.xywh(11, 11, 1, 1, CellConstraints.LEFT, CellConstraints.FILL));
			...
			//======== spDetalle ========
			{
				...
				//======== panel11 ========
				{
					...
					//======== panel10 ========
					{
						...
						panel10.add(lblPorcentajeOtroImpuesto, cc.xywh(15, 13, 1, 1, CellConstraints.RIGHT, CellConstraints.FILL));
				...
				//======== panel2 ========
				{
					...
					//======== spTblGasto ========
					{
						...
						tblGasto.setModel(new DefaultTableModel(
							...
							new String[] {
								"Gasto", "Tipo Gasto", "Valor", "Detalle Gasto", "Compras Asociadas"
							}
						) {
							Class[] columnTypes = new Class[] {
								Object.class, Object.class, Double.class, Object.class, Object.class
							};
							boolean[] columnEditable = new boolean[] {
			...
			//======== spRetenciones ========
			{
				...
				//======== panelRetenciones ========
				{
					...
					panelRetenciones.add(btnAnularRetenciones, cc.xywh(11, 3, 1, 1, CellConstraints.LEFT, CellConstraints.DEFAULT));
					panelRetenciones.add(txtSecuencial, cc.xy(9, 3));

					//---- btnGuardar ----
					btnGuardar.setText("Guardar");
					btnGuardar.setHorizontalAlignment(SwingConstants.CENTER);
					panelRetenciones.add(btnGuardar, cc.xywh(13, 3, 1, 1, CellConstraints.RIGHT, CellConstraints.DEFAULT));
	...
	private JLabel lblOrdenesAsociadas;
	private JButton btnManejarOrdenes;
	private JButton btnActivarBusquedaOrdenes;
	...
	private JButton btnAnularRetenciones;
	...
	public JLabel getLblRetencionRenta() {
		return lblRetencionRenta;
	}
	...
	public JLabel getLblRetencionIva() {
		return lblRetencionIva;
	}
	...
	public JButton getBtnGuardarGasto() {
		return btnGuardarGasto;
	}
	...
	public JButton getBtnAnularRetenciones() {
		return btnAnularRetenciones;
	}
	...
	public JButton getBtnManejarOrdenes() {
		return btnManejarOrdenes;
	}

	public JButton getBtnActivarBusquedaOrdenes() {
		return btnActivarBusquedaOrdenes;
	}
}
