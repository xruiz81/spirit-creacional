...
public abstract class JPFamiliaGenerico extends MantenimientoModelImpl {
	public JPFamiliaGenerico() {
		initComponents();
		setName("Familia Generico");
	}
	...
	private void initComponents() {
		...
		//======== spTblFamiliaGenerico ========
		{
			...
			tblFamiliaGenerico.getTableHeader().setReorderingAllowed(false);
	...
	public JTable getTblFamiliaGenerico() {
		return tblFamiliaGenerico;
	}

	public void setTblFamiliaGenerico(JTable tblFamiliaGenerico) {
		this.tblFamiliaGenerico = tblFamiliaGenerico;
	}
