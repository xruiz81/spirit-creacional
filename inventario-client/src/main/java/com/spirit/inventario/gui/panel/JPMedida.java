...
public abstract class JPMedida extends MantenimientoModelImpl {
	public JPMedida() {
		initComponents();
		setName("Medida");
	}
	...
	private void initComponents() {
		...
		spTblMedida = new JScrollPane();
		tblMedida = new JTable();
		...
		//======== spTblMedida ========
		{
			...
			//---- tblMedida ----
			tblMedida.setModel(new DefaultTableModel(
				new Object[][] {
				},
				new String[] {
					"C\u00f3digo", "Nombre"
			...
			tblMedida.getTableHeader().setReorderingAllowed(false);
			spTblMedida.setViewportView(tblMedida);
		}
		add(spTblMedida, cc.xywh(3, 9, 7, 5));
	...
	private JScrollPane spTblMedida;
	private JTable tblMedida;
	// JFormDesigner - End of variables declaration  //GEN-END:variables
	
	public JTable getTblMedida() {
		return tblMedida;
	}

	public void setTblMedida(JTable tblMedida) {
		this.tblMedida = tblMedida;
	}
