 ...
 */
public abstract class JPPersonalizacionTamanio extends MantenimientoModelImpl {
	public JPPersonalizacionTamanio() {
		initComponents();
	}
	...
	private void initComponents() {
		...
		spTblTamanio = new JScrollPane();
		tblTamanio = new JTable();
		CellConstraints cc = new CellConstraints();

		//======== this ========
		setName("Personalizacion Tamano");
		...
		//======== spTblTamanio ========
		{
			...
			//---- tblTamanio ----
			tblTamanio.setModel(new DefaultTableModel(
				new Object[][] {
					{null, null},
				},
				new String[] {
			...
			spTblTamanio.setViewportView(tblTamanio);
		}
		add(spTblTamanio, cc.xywh(3, 9, 9, 5));
	...
	private JScrollPane spTblTamanio;
	private JTable tblTamanio;
	...
	public JScrollPane getSpTblTamanio() {
		return spTblTamanio;
	}

	public JTable getTblTamanio() {
		return tblTamanio;
	}
}
