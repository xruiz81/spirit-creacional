...
/*
 * Created by JFormDesigner on Wed Sep 23 15:14:00 COT 2009
 */
 ...
 */
public abstract class JPPersonalizacionTipoLetra extends MantenimientoModelImpl {
	public JPPersonalizacionTipoLetra() {
		initComponents();
	}
	...
	private void initComponents() {
		...
		spTblTipoLetra = new JScrollPane();
		tblTipoLetra = new JTable();
		CellConstraints cc = new CellConstraints();

		//======== this ========
		setName("Personalizacion Tipo Letra");
		...
		//======== spTblTipoLetra ========
		{
			...
			//---- tblTipoLetra ----
			tblTipoLetra.setModel(new DefaultTableModel(
				new Object[][] {
					{null, null},
				},
				new String[] {
			...
			spTblTipoLetra.setViewportView(tblTipoLetra);
		}
		add(spTblTipoLetra, cc.xywh(3, 9, 9, 5));
	...
	private JScrollPane spTblTipoLetra;
	private JTable tblTipoLetra;
	...
	public JScrollPane getSpTblTipoLetra() {
		return spTblTipoLetra;
	}

	public JTable getTblTipoLetra() {
		return tblTipoLetra;
	}
}
