...
import com.spirit.pos.gui.panel.JDAutorizacionSupervisor;
import com.spirit.util.Utilitarios;


public class AutorizacionModel extends JDAutorizacionSupervisor{

	public boolean correctousr=false;
	 	String clave="";	 
	 	Long usuarioId;
	
	public AutorizacionModel(Frame owner) {
		super(owner);
