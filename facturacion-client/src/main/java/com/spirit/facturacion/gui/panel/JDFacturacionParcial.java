 ...
 * @author xruiz
 */
public class JDFacturacionParcial extends JDialog {
	public JDFacturacionParcial(Frame owner) {
		super(owner);
		initComponents();
	}

	public JDFacturacionParcial(Dialog owner) {
		super(owner);
		initComponents();
	}
		...
		//======== panel1 ========
		{
			...
			//======== spTblPresupuestoDetalles ========
			{
				...
				tblPresupuestoDetalles.setModel(new DefaultTableModel(
					...
					new String[] {
						"", "Proveedor", "Producto", "Orden", "Valor"
					}
				) {
