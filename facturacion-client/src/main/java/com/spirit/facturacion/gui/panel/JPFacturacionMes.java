...
public abstract class JPFacturacionMes extends SpiritModelImpl {
	public JPFacturacionMes() {
		initComponents();
		setName("Facturacion por Mes");
	}
	...
	private void initComponents() {
		...
		add(spTblFacturacion, cc.xywh(3, 11, 23, 5));
