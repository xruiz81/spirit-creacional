...
public abstract class JPFixAsientoCostoVenta extends MantenimientoModelImpl {
	public JPFixAsientoCostoVenta() {
		initComponents();
		setName("Fix Asiento Costo Venta");
	}
	...
	private void initComponents() {
		...
		//---- lblMensaje1 ----
		lblMensaje1.setText("El siguiente proceso corregir\u00e1 los asientos de costo de ventas");
