...
public abstract class JPFactura extends SpiritModelImpl {
	public JPFactura() {
		initComponents();
		setName("Factura");
	}
			...
			//======== scrollPane1 ========
			{
				...
				//======== panel3 ========
				{
					...
					//======== panel5 ========
					{
						...
						panel5.add(lblPresupuesto, cc.xywh(3, 4, 1, 1, CellConstraints.RIGHT, CellConstraints.FILL));
					...
					//======== panel10 ========
					{
						...
						//======== scPlantilla ========
						{
							...
							tblFacturaDetalle.setModel(new DefaultTableModel(
								...
								new String[] {
									"Descripci\u00f3n", "Cantidad", "Precio Real", "Dscto. Agencia", "Descuento Global", "Iva", "Dctos. Varios"
								}
							) {
