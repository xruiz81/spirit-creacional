...
public abstract class JPFacturacionClientes extends SpiritModelImpl {
	public JPFacturacionClientes() {
		initComponents();
		setName("Facturacion Clientes");
	}
	...
	private void initComponents() {
		...
		rbReportePreimpreso = new JRadioButton();
		lblFechaInicio = new JLabel();
		cmbFechaInicio = new DateComboBox();
		lblFechaFin = new JLabel();
		cmbFechaFin = new DateComboBox();
		rbReporteCorporacion = new JRadioButton();
		lblTipoDocumento = new JLabel();
		cmbTipoDocumento = new JComboBox();
		cbSinNotasCredito = new JCheckBox();
		rbReporteCliente = new JRadioButton();
		spTblFacturacion = new JScrollPane();
		tblFacturacion = new JTable();
		lblIVA = new JLabel();
		cmbIVA = new JComboBox();
		btnConsultar = new JButton();
		rbReporteEquipo = new JRadioButton();
		cbReporteEquipoResumen = new JCheckBox();
		rbReporteEjecutivo = new JRadioButton();
		...
		//---- rbReportePreimpreso ----
		rbReportePreimpreso.setText("Reporte por # Factura");
		add(rbReportePreimpreso, cc.xy(21, 3));
		...
		//---- rbReporteCorporacion ----
		rbReporteCorporacion.setText("Reporte por Corporaci\u00f3n");
		add(rbReporteCorporacion, cc.xy(21, 5));
		...
		add(cbSinNotasCredito, cc.xy(11, 7));

		//---- rbReporteCliente ----
		rbReporteCliente.setText("Reporte por Cliente");
		add(rbReporteCliente, cc.xy(21, 7));
		...
		//======== spTblFacturacion ========
		{
			...
			tblFacturacion.setModel(new DefaultTableModel(
				...
				new String[] {
					"# Factura", "Fecha Emisi\u00f3n", "Cliente", "R", "A", "Suma", "Descuento", "Comisi\u00f3n", "SubTotal", "12% IVA", "TOTAL US$"
				}
			) {
		...
		add(spTblFacturacion, cc.xywh(3, 13, 23, 5));

		//---- lblIVA ----
		lblIVA.setText("IVA:");
		add(lblIVA, cc.xywh(3, 9, 1, 1, CellConstraints.RIGHT, CellConstraints.DEFAULT));
		...
		add(cmbIVA, cc.xy(5, 9));

		//---- btnConsultar ----
		btnConsultar.setText("Consultar");
		add(btnConsultar, cc.xy(11, 9));

		//---- rbReporteEquipo ----
		rbReporteEquipo.setText("Reporte por Equipo");
		add(rbReporteEquipo, cc.xy(21, 9));

		//---- cbReporteEquipoResumen ----
		cbReporteEquipoResumen.setText("Resumen");
		add(cbReporteEquipoResumen, cc.xy(23, 9));

		//---- rbReporteEjecutivo ----
		rbReporteEjecutivo.setText("Reporte por Ejecutivo");
		add(rbReporteEjecutivo, cc.xy(21, 11));

		//---- buttonGroup1 ----
		ButtonGroup buttonGroup1 = new ButtonGroup();
		buttonGroup1.add(rbReportePreimpreso);
		buttonGroup1.add(rbReporteCorporacion);
		buttonGroup1.add(rbReporteCliente);
		buttonGroup1.add(rbReporteEquipo);
		buttonGroup1.add(rbReporteEjecutivo);
	...
	private JRadioButton rbReportePreimpreso;
	private JLabel lblFechaInicio;
	private DateComboBox cmbFechaInicio;
	private JLabel lblFechaFin;
	private DateComboBox cmbFechaFin;
	private JRadioButton rbReporteCorporacion;
	private JLabel lblTipoDocumento;
	private JComboBox cmbTipoDocumento;
	private JCheckBox cbSinNotasCredito;
	private JRadioButton rbReporteCliente;
	private JScrollPane spTblFacturacion;
	private JTable tblFacturacion;
	private JLabel lblIVA;
	private JComboBox cmbIVA;
	private JButton btnConsultar;
	private JRadioButton rbReporteEquipo;
	private JCheckBox cbReporteEquipoResumen;
	private JRadioButton rbReporteEjecutivo;
	// JFormDesigner - End of variables declaration  //GEN-END:variables
	
	public JRadioButton getRbReportePreimpreso() {
		return rbReportePreimpreso;
	}

	public JRadioButton getRbReporteCorporacion() {
		return rbReporteCorporacion;
	}

	public JRadioButton getRbReporteCliente() {
		return rbReporteCliente;
	}

	public JRadioButton getRbReporteEquipo() {
		return rbReporteEquipo;
	}

	public JRadioButton getRbReporteEjecutivo() {
		return rbReporteEjecutivo;
	}
	...
	public JCheckBox getCbReporteEquipoResumen() {
		return cbReporteEquipoResumen;
	}
}
