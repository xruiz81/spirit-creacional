 ...
 */
public abstract class JPFixTotalesFacturas extends MantenimientoModelImpl {
	public JPFixTotalesFacturas() {
		initComponents();
		setName("Fix Totales Facturas");
	}
	...
	private void initComponents() {
		...
		//---- lblMensaje1 ----
		lblMensaje1.setText("El siguiente proceso corregir\u00e1 los totales de las facturas");
