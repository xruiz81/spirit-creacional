...
public class MyTreeTableModelEstadoResultadoComparativo extends TreeTableModel implements StyleModel {
	 
	//Creacion de las columnas del TreeTable
	static final protected String[] COLUMN_NAMES = {"Nombre", "Valor", "Margen", "%", "Valor C.", "Margen C.", "% C.", "Diferencia"};

	    public MyTreeTableModelEstadoResultadoComparativo(List filas) {
	    	super(filas);
	    }
	    
	    public MyTreeTableModelEstadoResultadoComparativo() {
	    ...
	    public Class getColumnClass(int columnIndex) {
	        switch (columnIndex) {
	            case 0:
	                return MyRowTreeTableEstadoResultadosComparativo.class;
	            case 1:
