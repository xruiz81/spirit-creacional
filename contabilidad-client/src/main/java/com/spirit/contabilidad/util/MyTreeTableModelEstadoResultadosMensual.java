...
public class MyTreeTableModelEstadoResultadosMensual extends MyTreeTableModelEstadoResultados implements StyleModel {
	//Creacion de las columnas del TreeTable
	static final protected String[] COLUMN_NAMES = {"Cuenta", "ENE", "FEB", "MAR", "ABR", "MAY", "JUN", "JUL", "AGO", "SEP", "OCT", "NOV", "DIC", "TOTAL"};
	
	public MyTreeTableModelEstadoResultadosMensual(List filas) {
		super(filas);
	}
	
	public MyTreeTableModelEstadoResultadosMensual() {
	...
	public CellStyle getCellStyleAt(int rowIndex, int columnIndex) {
		if (columnIndex == 0) {
			...
			return CELL_STYLE;
		} else if(columnIndex >= 1 || columnIndex <= 13){
