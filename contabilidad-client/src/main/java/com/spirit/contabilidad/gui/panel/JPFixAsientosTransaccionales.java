...
public abstract class JPFixAsientosTransaccionales extends MantenimientoModelImpl {
	public JPFixAsientosTransaccionales() {
		initComponents();
		setName("Fix Asientos Transaccionales");
	}
	...
	private void initComponents() {
		...
		//---- lblMensaje1 ----
		lblMensaje1.setText("El siguiente proceso corregir\u00e1 las glosas de los detalles de los asientos transaccionales");
