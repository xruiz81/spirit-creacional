...
public class FondoRotativoFacturaCanceladaData implements Serializable {
	...
	/*String codigoComprobanteFacturaCancelada = "";
	String detalleComprobanteFacturaCancelada = "";
	Double valorComprobanteFacturaCancelada = 0D;
	String detalleFacturaCancelada = "";
	Double valorFacturaCancelada = 0D;*/
	...
	public FondoRotativoFacturaCanceladaData() {
	}
