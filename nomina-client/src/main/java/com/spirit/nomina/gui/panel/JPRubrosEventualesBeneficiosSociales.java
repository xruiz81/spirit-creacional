...
public abstract class JPRubrosEventualesBeneficiosSociales extends SpiritModelImpl {
	public JPRubrosEventualesBeneficiosSociales() {
		initComponents();
	}
	...
	private void initComponents() {
		...
		//======== this ========
		setName("Eventuales de Beneficios Sociales");
		setLayout(new FormLayout(
			new ColumnSpec[] {
				...
				FormFactory.LABEL_COMPONENT_GAP_COLSPEC,
				new ColumnSpec(ColumnSpec.RIGHT, Sizes.dluX(40), FormSpec.NO_GROW),
				FormFactory.LABEL_COMPONENT_GAP_COLSPEC,
		...
		add(panelEmitirCheque, cc.xywh(7, 15, 2, 1));
		add(cmbTipoRolPago, cc.xywh(7, 17, 5, 1));
		...
		add(lblPagoFinMes, cc.xywh(3, 19, 3, 1));
		...
		add(panelEmitirCheque2, cc.xy(7, 19));
