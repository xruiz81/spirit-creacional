...
public class MyScrollTableModel extends AbstractMultiTableModel  implements TableModelListener {
	     ...
	     * @see #setValueAt
	     */
	    public MyScrollTableModel(int rowCount, int columnCount) {
	     ...
	     * @see #setValueAt
	     */
	    public MyScrollTableModel(Vector columnNames, int rowCount) {
	     ...
	     * @see #setValueAt
	     */
	    public MyScrollTableModel(Object[] columnNames, int rowCount) {
	        this(convertToVector(columnNames), rowCount);
	    }
	    
	    
	    /**
	     * Consrtructor de Tabla con Scroll desde la columna enviada
		 * @param columEditable El numero de columna desde la cual se pueden editar los valores
		 * @param columnNames La cabecera conlos nombres de las columnas
		 */
		public MyScrollTableModel(int columEditable,Object[] columnNames){
			setDataVector(newVector(0), convertToVector(columnNames));
			this.columEditable = columEditable;
	     ...
	     * @see #setDataVector
	     */
	    public MyScrollTableModel(Vector data, Vector columnNames) {
	     ...
	     * @see #setDataVector
	     */
	    public MyScrollTableModel(Object[][] data, Object[] columnNames) {
	        setDataVector(data, columnNames);
	    }
...
//	 Protected Methods
	//
	    ...
	    public boolean isCellEditable(int row, int column) {
	    	 return column >= columEditable; // only cells in the main table are editable.
	    }
	    ...
	    protected static Vector convertToVector(Object[][] anArray) {
	     ...
	     public void tableChanged(TableModelEvent e) {
	         ...
	         if(column!=-1){
			     ...
			     Vector rowVector = (Vector)dataVector.elementAt(row);
			     rowVector.setElementAt(data.toString().toUpperCase(), column);	 
	         }
	     }
