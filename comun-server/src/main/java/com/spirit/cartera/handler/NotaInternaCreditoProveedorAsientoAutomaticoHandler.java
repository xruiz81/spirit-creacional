...
@Stateless
public class NotaInternaCreditoProveedorAsientoAutomaticoHandler implements NotaInternaCreditoProveedorAsientoAutomaticoHandlerLocal {
	...
	public AsientoIf generarNotaInternaCreditoProveedorAsientoAutomaticoHandler(EventoContableIf eventoContable, Map parameterMap, boolean procesarAsiento) throws GenericBusinessException {
		...
		this.idOficina = eventoContable.getOficinaId();
	...
	public AsientoIf generarAsientoContable() throws GenericBusinessException {
		...
		try {
			...
			Long proveedorOficinaId = ((CarteraIf) this.referenceBeanCartera).getClienteoficinaId();
			ClienteOficinaIf proveedorOficina = clienteOficinaLocal.getClienteOficina(proveedorOficinaId);
	...
	public void setAsientoDetalleColeccion(List<AsientoDetalleIf> asientoDetalleColeccion) {
		NotaInternaCreditoProveedorAsientoAutomaticoHandler.asientoDetalleColeccion = asientoDetalleColeccion;
	}
}
