...
public abstract class _PersonalizacionUbicacionSession {
     ...
     throws com.spirit.exception.GenericBusinessException 
   {
      ...
      queryManagerLocal.persist(value);
        ...
        log.error("Error al insertar información en personalizacionUbicacion.", e);
			throw new GenericBusinessException(
					"Error al insertar información en personalizacionUbicacion.");
      }
    ...
    throws com.spirit.exception.GenericBusinessException 
   {
      ...
      data.setEmpresaId(model.getEmpresaId());
       queryManagerLocal.save(data);
        ...
        log.error("Error al actualizar información en personalizacionUbicacion.", e);
			throw new GenericBusinessException(
					"Error al actualizar información en personalizacionUbicacion.");
      }
   ...
   public void deletePersonalizacionUbicacion(java.lang.Long id) throws com.spirit.exception.GenericBusinessException 
   {
    try
      ...
      queryManagerLocal.remove(data);
        ...
        log.error("Error al eliminar información en personalizacionUbicacion.", e);
			throw new GenericBusinessException(
					"Error al eliminar información en personalizacionUbicacion.");
      }
