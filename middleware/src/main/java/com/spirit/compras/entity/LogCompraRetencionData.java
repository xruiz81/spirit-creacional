 ...
 *
 */
public class LogCompraRetencionData implements LogCompraRetencionIf, Serializable    {
   ...
   public LogCompraRetencionData() {
   }

   public LogCompraRetencionData(com.spirit.compras.entity.LogCompraRetencionIf value) {
      setId(value.getId());
