...
@Table(name = "LOG_COMPRA_RETENCION")
@Entity
public class LogCompraRetencionEJB implements Serializable, LogCompraRetencionIf {
   ...
   public LogCompraRetencionEJB() {
   }

   public LogCompraRetencionEJB(com.spirit.compras.entity.LogCompraRetencionIf value) {
      setId(value.getId());
   ...
   public java.lang.Long create(com.spirit.compras.entity.LogCompraRetencionIf value) {
      setId(value.getId());
      setEstablecimiento(value.getEstablecimiento());
      setPuntoEmision(value.getPuntoEmision());
      setSecuencial(value.getSecuencial());
...
@TableGenerator(name="SEQ_GEN",
   ...
   public void setLog(java.lang.String log) {
	...
	public String toString() {
		return ToStringer.toString((LogCompraRetencionIf)this);
	}
}
