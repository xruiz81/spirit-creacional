 ...
 *
 */
public class ClienteZonaData implements ClienteZonaIf, Serializable    {
   ...
   public ClienteZonaData() {
   }

   public ClienteZonaData(com.spirit.crm.entity.ClienteZonaIf value) {
      setId(value.getId());
