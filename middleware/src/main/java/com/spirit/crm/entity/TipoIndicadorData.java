 ...
 *
 */
public class TipoIndicadorData implements TipoIndicadorIf, Serializable    {
   ...
   public TipoIndicadorData() {
   }

   public TipoIndicadorData(com.spirit.crm.entity.TipoIndicadorIf value) {
      setId(value.getId());
