 ...
 *
 */
public class MarcaProductoData implements MarcaProductoIf, Serializable    {
   ...
   public MarcaProductoData() {
   }

   public MarcaProductoData(com.spirit.medios.entity.MarcaProductoIf value) {
      setId(value.getId());
