 ...
 *
 */
public class Timetracker2Data implements Timetracker2If, Serializable    {
   ...
   public Timetracker2Data() {
   }

   public Timetracker2Data(com.spirit.medios.entity.Timetracker2If value) {
      setId(value.getId());
