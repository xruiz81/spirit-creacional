 ...
 *
 */
public class SubtipoOrdenData implements SubtipoOrdenIf, Serializable    {
   ...
   public SubtipoOrdenData() {
   }

   public SubtipoOrdenData(com.spirit.medios.entity.SubtipoOrdenIf value) {
      setId(value.getId());
