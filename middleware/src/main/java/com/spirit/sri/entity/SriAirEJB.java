...
@Table(name = "SRI_AIR")
@Entity
public class SriAirEJB implements Serializable, SriAirIf {
   ...
   public SriAirEJB(com.spirit.sri.entity.SriAirIf value) {
      setId(value.getId());
   ...
   public java.lang.Long create(com.spirit.sri.entity.SriAirIf value) {
      setId(value.getId());
      setCodigo(value.getCodigo());
      setConcepto(value.getConcepto());
      setPorcentaje(value.getPorcentaje());
...
@TableGenerator(name="SEQ_GEN",
   ...
   public void setFechaFin(java.sql.Date fechaFin) {
	...
	public String toString() {
		return ToStringer.toString((SriAirIf)this);
	}
}
