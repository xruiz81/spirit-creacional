...
@Table(name = "SRI_IVA_BIEN")
@Entity
public class SriIvaBienEJB implements Serializable, SriIvaBienIf {
   ...
   public SriIvaBienEJB() {
   }

   public SriIvaBienEJB(com.spirit.sri.entity.SriIvaBienIf value) {
      setId(value.getId());
      setCodigo(value.getCodigo());
      setDescripcionPorcentaje(value.getDescripcionPorcentaje());
   }

   public java.lang.Long create(com.spirit.sri.entity.SriIvaBienIf value) {
      setId(value.getId());
      setCodigo(value.getCodigo());
      setDescripcionPorcentaje(value.getDescripcionPorcentaje());
