 ...
 * Schema.
 * $Id: DetalleAirType.java,v 1.1 2014/03/28 18:06:35 xrf Exp $
 */
...
public class DetalleAirType implements java.io.Serializable {
    ...
    public DetalleAirType() 
     {
        super();
    } //-- com.spirit.sri.at.DetalleAirType()
    ...
    public static com.spirit.sri.at.DetalleAirType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.spirit.sri.at.DetalleAirType) Unmarshaller.unmarshal(com.spirit.sri.at.DetalleAirType.class, reader);
