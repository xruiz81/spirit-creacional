 ...
 *
 */
public class CarteraDetalleData implements CarteraDetalleIf, Serializable    {
   ...
   public CarteraDetalleData() {
   }

   public CarteraDetalleData(com.spirit.cartera.entity.CarteraDetalleIf value) {
      setId(value.getId());
