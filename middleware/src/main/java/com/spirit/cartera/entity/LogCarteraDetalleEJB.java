...
@Table(name = "LOG_CARTERA_DETALLE")
@Entity
public class LogCarteraDetalleEJB implements Serializable, LogCarteraDetalleIf {
   ...
   public LogCarteraDetalleEJB() {
   }

   public LogCarteraDetalleEJB(com.spirit.cartera.entity.LogCarteraDetalleIf value) {
      setId(value.getId());
   ...
   public java.lang.Long create(com.spirit.cartera.entity.LogCarteraDetalleIf value) {
      setId(value.getId());
      setLogCarteraId(value.getLogCarteraId());
      setDocumentoId(value.getDocumentoId());
      setSecuencial(value.getSecuencial());
