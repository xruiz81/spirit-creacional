 ...
 *
 */
public class MovimientoBancoData implements MovimientoBancoIf, Serializable    {
   ...
   public MovimientoBancoData() {
   }

   public MovimientoBancoData(com.spirit.cartera.entity.MovimientoBancoIf value) {
      setId(value.getId());
