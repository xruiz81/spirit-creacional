 ...
 *
 */
public class TarjetaCreditoData implements TarjetaCreditoIf, Serializable    {
   ...
   public TarjetaCreditoData() {
   }

   public TarjetaCreditoData(com.spirit.pos.entity.TarjetaCreditoIf value) {
      setId(value.getId());
