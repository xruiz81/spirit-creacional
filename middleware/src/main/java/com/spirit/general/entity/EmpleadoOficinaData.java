 ...
 *
 */
public class EmpleadoOficinaData implements EmpleadoOficinaIf, Serializable    {
   ...
   public EmpleadoOficinaData() {
   }

   public EmpleadoOficinaData(com.spirit.general.entity.EmpleadoOficinaIf value) {
      setId(value.getId());
