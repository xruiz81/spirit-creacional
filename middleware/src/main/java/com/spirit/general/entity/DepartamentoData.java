 ...
 *
 */
public class DepartamentoData implements DepartamentoIf, Serializable    {
   ...
   public DepartamentoData(com.spirit.general.entity.DepartamentoIf value) {
      setId(value.getId());
   ...
   public String getPrimaryKeyParameters() {
	...
	public String toString() {
		return ToStringer.toString((DepartamentoIf)this);
	}
}
