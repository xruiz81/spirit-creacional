 ...
 *
 */
public class TipoEmpleadoData implements TipoEmpleadoIf, Serializable    {
   ...
   public TipoEmpleadoData() {
   }

   public TipoEmpleadoData(com.spirit.general.entity.TipoEmpleadoIf value) {
      setId(value.getId());
