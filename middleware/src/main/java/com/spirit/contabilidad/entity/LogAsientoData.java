 ...
 *
 */
public class LogAsientoData implements LogAsientoIf, Serializable    {
   ...
   public LogAsientoData() {
   }

   public LogAsientoData(com.spirit.contabilidad.entity.LogAsientoIf value) {
      setId(value.getId());
