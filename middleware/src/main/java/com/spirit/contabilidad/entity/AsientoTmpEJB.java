...
@Table(name = "ASIENTO_TMP")
@Entity
public class AsientoTmpEJB implements Serializable, AsientoTmpIf {
   ...
   public AsientoTmpEJB() {
   }

   public AsientoTmpEJB(com.spirit.contabilidad.entity.AsientoTmpIf value) {
      setId(value.getId());
   ...
   public java.lang.Long create(com.spirit.contabilidad.entity.AsientoTmpIf value) {
      setId(value.getId());
      setAsientoCierre(value.getAsientoCierre());
      setNumero(value.getNumero());
      setEmpresaId(value.getEmpresaId());
...
@TableGenerator(name="SEQ_GEN",
   ...
   public void setUsarNota(java.lang.String usarNota) {
	...
	public String toString() {
		return ToStringer.toString((AsientoTmpIf)this);
	}
}
