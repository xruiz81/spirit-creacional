 ...
 *
 */
public class AsientoTmpData implements AsientoTmpIf, Serializable    {
   ...
   public AsientoTmpData() {
   }

   public AsientoTmpData(com.spirit.contabilidad.entity.AsientoTmpIf value) {
      setId(value.getId());
