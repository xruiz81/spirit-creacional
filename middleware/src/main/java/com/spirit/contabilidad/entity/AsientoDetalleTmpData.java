 ...
 *
 */
public class AsientoDetalleTmpData implements AsientoDetalleTmpIf, Serializable    {
   ...
   public AsientoDetalleTmpData() {
   }

   public AsientoDetalleTmpData(com.spirit.contabilidad.entity.AsientoDetalleTmpIf value) {
      setId(value.getId());
