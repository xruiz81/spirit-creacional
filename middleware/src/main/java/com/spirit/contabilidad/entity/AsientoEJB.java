...
@Table(name = "ASIENTO")
@Entity
public class AsientoEJB implements Serializable, AsientoIf {
   ...
   public AsientoEJB(com.spirit.contabilidad.entity.AsientoIf value) {
      setId(value.getId());
   ...
   public java.lang.Long create(com.spirit.contabilidad.entity.AsientoIf value) {
      setId(value.getId());
      setNumero(value.getNumero());
      setEmpresaId(value.getEmpresaId());
      setPeriodoId(value.getPeriodoId());
