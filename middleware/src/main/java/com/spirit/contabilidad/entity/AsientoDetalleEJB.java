...
@Entity
public class AsientoDetalleEJB implements Serializable, AsientoDetalleIf {
   ...
   public AsientoDetalleEJB() {
   }

   public AsientoDetalleEJB(com.spirit.contabilidad.entity.AsientoDetalleIf value) {
      setId(value.getId());
   ...
   public java.lang.Long create(com.spirit.contabilidad.entity.AsientoDetalleIf value) {
      setId(value.getId());
      setCuentaId(value.getCuentaId());
      setAsientoId(value.getAsientoId());
      setReferencia(value.getReferencia());
