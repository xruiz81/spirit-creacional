...
public abstract class JPCruceCuentas extends SpiritModelImpl {
	public JPCruceCuentas() {
		initComponents();
		setName("Cruce de Cuentas");
	}
	...
	private void initComponents() {
		...
		spCuentasPorPagar = new JScrollPane();
		tblCuentasPorPagar = new JTable();
		fsCuentasPorPagar = compFactory.createSeparator("Cuentas por Pagar:");
		...
		//======== spCuentasPorPagar ========
		{
			...
			spCuentasPorPagar.setViewportView(tblCuentasPorPagar);
		}
		add(spCuentasPorPagar, cc.xywh(3, 23, 15, 5));
		add(fsCuentasPorPagar, cc.xywh(3, 21, 15, 1));
		...
		tblCuentasPorPagar.getColumnModel().getColumn(3).setCellRenderer(tableCellRenderer);
		...
		tblCuentasPorPagar.getColumnModel().getColumn(0).setCellRenderer(tableCellRendederHorizontalCenterAlignment);
		tblCuentasPorPagar.getColumnModel().getColumn(1).setCellRenderer(tableCellRendederHorizontalCenterAlignment);
	}
	...
	private JScrollPane spCuentasPorPagar;
	private JTable tblCuentasPorPagar;
	private JComponent fsCuentasPorPagar;
