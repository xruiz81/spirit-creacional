...
public abstract class JPFixRetencionProveedor extends SpiritModelImpl {
	public JPFixRetencionProveedor() {
		setName("Fix Retenciones Proveedor");
		initComponents();
	}
	...
	private void initComponents() {
		...
		//======== spRetencionesProveedor ========
		{
			...
			//======== panelRetencionesProveedor ========
			{
				...
				panelRetencionesProveedor.add(fsListadoCompras, cc.xywh(3, 3, 9, 1));
				...
				panelRetencionesProveedor.add(spCompras, cc.xywh(3, 7, 9, 5));
				panelRetencionesProveedor.add(fsRetenciones, cc.xywh(3, 15, 9, 1));
				...
				panelRetencionesProveedor.add(panel1, cc.xywh(3, 27, 9, 1));
				...
				panelRetencionesProveedor.add(spRetenciones, cc.xywh(3, 29, 9, 5));
			}
		...
		tblRetenciones.getColumnModel().getColumn(3).setCellRenderer(tableCellRenderer);
		tblRetenciones.getColumnModel().getColumn(5).setCellRenderer(tableCellRenderer);
		tblRetenciones.getColumnModel().getColumn(6).setCellRenderer(tableCellRenderer);
		
		btnActualizar.setToolTipText("Actualizar");
		btnActualizar.setIcon(SpiritResourceManager.getImageIcon("images/icons/funcion/updateElement.png"));
		btnActualizarTodos.setToolTipText("Actualizar Todos");
		btnActualizarTodos.setIcon(SpiritResourceManager.getImageIcon("images/icons/funcion/updateElement.png"));
		btnActualizarTodos.setText("");
		...
		column = tblRetenciones.getColumnModel().getColumn(8);
